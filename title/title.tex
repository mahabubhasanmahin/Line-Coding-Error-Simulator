...
\makeatletter
\HRule \\[0.4cm]
{ \huge \bfseries \ Error Simulation in Line Coding
}\\[0.2cm] 
\HRule \\[1.0cm]
...
\textsl{\large Section: 231 D2}\\[0.5cm] 
...
\textbf{Name} & \textbf{ID}\\
\hline
Majaharul Islam& 231902050\\
\hline
MD MAHABUB HASAN MAHIN& 231902056\\
\hline
Sweety Akter & 231902068 \\
\hline
\end{tabular}
\end{table*}
\vspace{0.5cm}
...
\textsl{\large Submission Date:   20 / 05 / 2025}\\ 
\textsl{\large Course Teacher’s Name: Md. Samin Hossain Utsho}\\[0.9cm] 
